        ...
        el("header.header",
          el(".nav",
            ...
            el("ul.menu",
              ...
              el("li.item", el("a.enter-app", "Enter App", { click: () => { new Alert("현재 준비중입니다.", "Gaia Protocol은 2022년 2월 10일에 민팅이 이루어 집니다.") } })),
            ),
          )
        ),
        el("main",
            ...
            el(".swiper-slide",
              el(".team", { "data-aos": "fade-up" },
                el(".content",
                  ...
                  el(".back",
                    el("a", "심영재", { href: "https://twitter.com/DSC_Hanul", target: "_blank" }),
                    el("h4", "Director"),
                    el("p",
              ...
              el(".team", { "data-aos": "fade-up" },
                el(".content",
                  ...
                  el(".back",
                    el("a", "조선우", { href: "https://twitter.com/Chowbie_", target: "_blank" }),
                    el("h4", "Art & Design"),
                    el("p",
              ...
              el(".team", { "data-aos": "fade-up" },
                el(".content",
                  ...
                  el(".back",
                    el("a", "TheGreatHB", { href: "https://twitter.com/TheGreatHB_", target: "_blank" }),
                    el("h4", "Development"),
                    el("p",
              ...
              el(".team", { "data-aos": "fade-up" },
                el(".content",
                  ...
                  el(".back",
                    el("a", "이학성", { href: "https://twitter.com/dilrong_", target: "_blank" }),
                    el("h4", "Development"),
                    el("p",
              ...
              el(".team", { "data-aos": "fade-up" },
                el(".content",
                  ...
                  el(".back",
                    el("a", "박민", { href: "https://twitter.com/Medo_DSC", target: "_blank" }),
                    el("h4", "Marketing & CS"),
                    el("p",
              ...
              el(".team", { "data-aos": "fade-up" },
                el(".content",
                  ...
                  el(".back",
                    el("a", "강희민", { href: "https://twitter.com/Docent_Mgr", target: "_blank" }),
                    el("h4", "Marketing & CS"),
                    el("p",
