        ...
        Layout.current.content.append(
            this.container = el(".home-view flex h-screen flex-col",
                el(".m-auto flex flex-col items-center m-4 container mx-auto px-4", { id: "STORY" },
                    ...
                    el(".team content-center mt-64", { id: "TEAM" },
                        el("h1.text-5xl font-bold text-center text-primary", "TEAM"),
                        ...
                        el(".text-base text-center mt-8 mb-8",
                            ...
                            다년간 트위터 작품 활동을 통해 32만 팔로워를 보유하고 있으며, 
                            최근에는 한국의 NFT 및 P2E 게임 프로젝트에도 참여하고 있습니다.`
                        )
                    ),
                ...
                el("footer.bg-black p-8 mt-32",
                    el(".footer-container.container mx-auto px-4 flex justify-around",
                        el(".resources-container text-left text-xs flex flex-col",
                            el(".head.text-xl mb-2 font-bold", "Resources"),
                            el(".content flex flex-col text-gray-300",
                                el("a.documentation hover:underline mt-2", "Documentation", { href: "https://docs.gaiaprotocol.com/kr/", target: "_blank" }),
                            )
                        ),
                        el(".sns-container text-left text-xs",
                            el(".head.text-xl mb-2 font-semibold", "Community"),
                            el(".content flex text-gray-300 lg:flex-row mt-4",
