...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst skynode_1 = __webpack_require__(/*! @hanul/skynode */ \"./node_modules/@hanul/skynode/lib/index.js\");\nconst Alert_1 = __importDefault(__webpack_require__(/*! ../component/dialogue/Alert */ \"./src/component/dialogue/Alert.ts\"));\nclass Home {\n    constructor() {\n        this.container = (0, skynode_1.el)(\".home-view\", (0, skynode_1.el)(\"img\", { src: \"/images/logo-text.png\" }), (0, skynode_1.el)(\".timer\", (this.timer = (0, skynode_1.el)(\"span.timer\", \"0d 0h 0d 0s\"))), (0, skynode_1.el)(\".button-container\", (0, skynode_1.el)(\"button\", \"Enter App\", {\n            click: () => { new Alert_1.default(\"서비스 준비중입니다.\", \"2022년 2월 10일에 민팅이 진행됩니다.\"); }\n        }), (0, skynode_1.el)(\"button\", \"Read Docs\", {\n            click: () => { window.open(\"https://docs.gaiaprotocol.com/gaia-protocol/\"); }\n        }))).appendTo(skynode_1.BodyNode);\n        this.refresh();\n        this.interval = setInterval(() => this.refresh(), 1000);\n    }\n    async refresh() {\n        var dday = new Date(\"2 10, 2022, 0:00:00\").getTime();\n        var today = new Date().getTime();\n        var gap = dday - today;\n        var day = Math.ceil(gap / (1000 * 60 * 60 * 24));\n        var hour = Math.ceil((gap % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));\n        var min = Math.ceil((gap % (1000 * 60 * 60)) / (1000 * 60));\n        var sec = Math.ceil((gap % (1000 * 60)) / 1000);\n        this.timer.empty().appendText(`${day}d ${hour}h ${min}m ${sec}s`);\n    }\n    changeParams(params, uri) { }\n    close() {\n        clearInterval(this.interval);\n        this.container.delete();\n    }\n}\nexports[\"default\"] = Home;\n\n\n//# sourceURL=webpack:///./src/view/Home.ts?");
